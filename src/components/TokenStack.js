export default function TokenStack(tokens) {
    return (<div className="flex flex-col items-center justify-center w-screen h-screen space-y-6">
        <div className="flex">
            {/* <img className="w-12 h-12 rounded-full border-4 border-white" src="https://images.generated.photos/syc9o2f_obuIoFJBYnGFwnKNNz9LrnKDZcIfhnclJXM/rs:fit:512:512/Z3M6Ly9nZW5lcmF0/ZWQtcGhvdG9zL3Yz/XzA0OTMwMzBfMDA2/MzYzNl8wMTU5Nzkx/LmpwZw.jpg" alt="" />
            ...
            {/* <span className="flex items-center justify-center font-semibold text-gray-600 w-12 h-12 rounded-full bg-gray-200 border-4 border-white -ml-4">+3</span> */}
        </div>
    </div>
    );
}